...
class Ui_Graficacion(QMainWindow):
    ...
    def setupUi(self, ventana):
        ...
        verticalLayout_2.setStretch(17, 20)
        verticalLayout_2.setStretch(18, 40)
        ...
        horizontalLayout_7.setContentsMargins(20, 10, 20, 10)
        ...
        self.label_15.setMinimumSize(QSize(130, 30))
        self.label_15.setMaximumSize(QSize(130, 30))
        ...
        horizontalLayout_9.setContentsMargins(0, 10, 0, 10)
        ...
        horizontalLayout_9.addWidget(self.ProyeccionEntrada, alignment=Qt.AlignHCenter)
        ...
        horizontalLayout_9.addWidget(self.Modo)
        ...
        horizontalLayout_9.addWidget(self.SolucionParcial)
