...
class ReproductorGeneral(FuncAnimation):
    ...
    def botonesReproduccion(self):
        ...
        self.espacio_reproduccionAtras = self.cuadricula.append_axes("right", size="100%", pad=0.05)
        self.espacio_detener = self.cuadricula.append_axes("right", size="100%", pad=0.05)
        self.espacio_reproduccion = self.cuadricula.append_axes("right", size="100%", pad=0.05)
        self.espacio_pasoAdelante = self.cuadricula.append_axes("right", size="100%", pad=0.05)
