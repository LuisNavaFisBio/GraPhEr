...
class ReproductorGeneral(FuncAnimation):
    ...
    def botonesReproduccion(self):
        ...
        self.espacio_pasoAtras = self.cuadricula.append_axes("right", size="90%", pad=0.05)
        self.espacio_reproduccionAtras = self.cuadricula.append_axes("right", size="90%", pad=0.05)
        self.espacio_detener = self.cuadricula.append_axes("right", size="90%", pad=0.05)
        self.espacio_reproduccion = self.cuadricula.append_axes("right", size="90%", pad=0.05)
        self.espacio_pasoAdelante = self.cuadricula.append_axes("right", size="90%", pad=0.05)
        self.boton_pasoAtras = mpl.widgets.Button(self.espacio_pasoAtras, label='$\u29CF$')
